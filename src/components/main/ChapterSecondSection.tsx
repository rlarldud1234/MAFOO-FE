import { ArrowRightImage, RunningImage } from "@/assets/images";
...
const ChapterSecondSection = () => {
  return (
    <Container>
      <ChapterImage src={RunningImage} alt="runningBoy" />
      <ChapterContainer>
        <ChapterText>Chapter 2</ChapterText>
        <TitleText>
          개쩌는 기능을
          <br />한 눈에 확인하세요.
        </TitleText>
...
`;
export default ChapterSecondSection;
